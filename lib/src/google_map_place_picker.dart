...
import 'package:google_maps_place_picker_mb_v2/src/components/animated_pin.dart';
...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  Widget _buildGoogleMap(BuildContext context) {
    return Selector<PlaceProvider, MapType>(
      ...
      builder:
          (_, data, __) => this._buildGoogleMapInner(
      ...
      builder: (context, data, __) {
        if ((data.item1 == null && data.item2 == SearchingState.Idle) ||
          ...
          if (selectedPlaceWidgetBuilder == null) {
            ...
            return Builder(
              builder:
                  (builderContext) => selectedPlaceWidgetBuilder!(
                    builderContext,
                    data.item1,
                    data.item2,
                    data.item3,
  ...
  Widget _buildZoomButtons() {
    return Selector<PlaceProvider, Tuple2<GoogleMapController?, LatLng?>>(
      selector:
          (_, provider) => new Tuple2<GoogleMapController?, LatLng?>(
